...
class Server(AuthorizationEndpoint, IntrospectEndpoint, TokenEndpoint,
    ...
    def __init__(self, request_validator, token_expires_in=None,
        ...
        self.auth_grant_choice = AuthorizationCodeGrantDispatcher(default_grant=self.auth_grant,
                                                                  oidc_grant=self.openid_connect_auth)
        self.implicit_grant_choice = ImplicitTokenGrantDispatcher(default_grant=self.implicit_grant,
        ...
        self.token_grant_choice = AuthorizationTokenGrantDispatcher(request_validator, default_grant=self.auth_grant,
                                                                    oidc_grant=self.openid_connect_auth)
